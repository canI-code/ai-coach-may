...
export function buildNarrativePrompt(args: NarrativePromptArgs): LLMRequest {
  const prompt = [
    ...
    '2. Generate a list of personalized recommendations (recommendations). For each weakness tag flagged, generate 2 to 4 targeted study recommendations (including a mix of free courses, paid courses, and YouTube videos/tutorials where possible).',
    '   Each recommendation must include:',
    '   - title: A specific, clear name for the study resource/topic.',
    '   - url: A high-quality, real, and publicly accessible web URL for learning more about this topic (e.g. developer.mozilla.org, system-design-primer on github, harvard business review, or similar high-quality references). Make sure the URL is valid, real, and working.',
